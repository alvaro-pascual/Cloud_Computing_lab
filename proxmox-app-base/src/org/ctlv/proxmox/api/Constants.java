...
public class Constants {
	...
	public static String USER_NAME = "pascuall"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "xxxxxxxx"; // votre mot de passe . XXX
	
	
	public static String HOST = "srv-px1.insa-toulouse.fr";  // XXX
	public static String REALM = "Ldap-INSA";
	
	public static String SERVER7 = "srv-px7";  // exemple "srv-px2" XXX
	public static String SERVER8 = "srv-px8";  // XXX
	public static String CT_BASE_NAME = "ct-tpgei-virt-bD2-ct";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
	public static long CT_BASE_ID = 4200;	 // � modifier (cf. sujet de tp) XXX
